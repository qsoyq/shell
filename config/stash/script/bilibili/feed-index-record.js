...
/** @namespace bilibili.feed.index.record */

/**
 * @typedef {Object} bilibili.feed.index.record.HTTPResponse
...
/**
 * @typedef {function(Error|string|null, Object, string|null): void} bilibili.feed.index.record.HTTPCallback
...
/**
 * @typedef {function(Object, bilibili.feed.index.record.HTTPCallback): bilibili.feed.index.record.HTTPResponse} bilibili.feed.index.record.HTTPMethod
 */

/**
 * @typedef {Object} bilibili.feed.index.record.HttpClient
 * @property {bilibili.feed.index.record.HTTPMethod} get - 发送 GET 请求
 * @property {bilibili.feed.index.record.HTTPMethod} post - 发送 POST 请求
 * @property {bilibili.feed.index.record.HTTPMethod} put - 发送 PUT 请求
 * @property {bilibili.feed.index.record.HTTPMethod} delete - 发送 DELETE 请求
 */

/** @type {bilibili.feed.index.record.HttpClient} */
var $httpClient;
 ...
 * @returns {Promise<bilibili.feed.index.record.HTTPResponse>} 返回一个 Promise，解析为包含 error、response 和 data 的对象
 * @throws {Error} 如果请求失败，Promise 会被拒绝并返回错误信息
 */
async function request(method, params) {
    return new Promise((resolve, reject) => {
        /** @type {bilibili.feed.index.record.HTTPMethod} */
 ...
 * 请求封装
 * @param {object} params
 * @returns {Promise<bilibili.feed.index.record.HTTPResponse>}
 */
