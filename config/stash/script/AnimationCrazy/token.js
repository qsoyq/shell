...
/**
 * @typedef {Object} ani.crazy.HTTPResponse
...
/**
 * @typedef {function(Error|string|null, Object, string|null): void} ani.crazy.HTTPCallback
...
/**
 * @typedef {function(Object, ani.crazy.HTTPCallback): ani.crazy.HTTPResponse} ani.crazy.HTTPMethod
 */

/**
 * @typedef {Object} ani.crazy.HttpClient
 * @property {ani.crazy.HTTPMethod} get - 发送 GET 请求
 * @property {ani.crazy.HTTPMethod} post - 发送 POST 请求
 * @property {ani.crazy.HTTPMethod} put - 发送 PUT 请求
 * @property {ani.crazy.HTTPMethod} delete - 发送 DELETE 请求
 */

/** @type {ani.crazy.HttpClient} */
var $httpClient;
 ...
 * @returns {Promise<ani.crazy.HTTPResponse>} 返回一个 Promise，解析为包含 error、response 和 data 的对象
 * @throws {Error} 如果请求失败，Promise 会被拒绝并返回错误信息
 */
async function request(method, params) {
    return new Promise((resolve, reject) => {
        /** @type {ani.crazy.HTTPMethod} */
 ...
 * 请求封装
 * @param {object} params
 * @returns {Promise<ani.crazy.HTTPResponse>}
 */
...
async function main() {
    let body = { "src": "", "animeSn": 113645, "r18": 3, "vip": false, "time": 0, "login": false, "promote": [] }
