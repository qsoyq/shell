...
/**
 * @typedef {Object} x.home.HTTPResponse
...
/**
 * @typedef {function(Error|string|null, Object, string|null): void} x.home.HTTPCallback
...
/**
 * @typedef {function(Object, x.home.HTTPCallback): x.home.HTTPResponse} x.home.HTTPMethod
 */

/**
 * @typedef {Object} x.home.HttpClient
 * @property {x.home.HTTPMethod} get - 发送 GET 请求
 * @property {x.home.HTTPMethod} post - 发送 POST 请求
 * @property {x.home.HTTPMethod} put - 发送 PUT 请求
 * @property {x.home.HTTPMethod} delete - 发送 DELETE 请求
 */

/** @type {x.home.HttpClient} */
var $httpClient;
 ...
 * @returns {Promise<x.home.HTTPResponse>} 返回一个 Promise，解析为包含 error、response 和 data 的对象
 * @throws {Error} 如果请求失败，Promise 会被拒绝并返回错误信息
 */
async function request(method, params) {
    return new Promise((resolve, reject) => {
        /** @type {x.home.HTTPMethod} */
 ...
 * 请求封装
 * @param {object} params
 * @returns {Promise<x.home.HTTPResponse>}
 */
