/** @namespace tastien.sign */

/**
 * @typedef {Object} tastien.sign.HTTPResponse
...
/**
 * @typedef {function(Error|string|null, Object, string|null): void} tastien.sign.HTTPCallback
...
/**
 * @typedef {function(Object, tastien.sign.HTTPCallback): tastien.sign.HTTPResponse} tastien.sign.HTTPMethod
 */

/**
 * @typedef {Object} tastien.sign.HttpClient
 * @property {tastien.sign.HTTPMethod} get - 发送 GET 请求
 * @property {tastien.sign.HTTPMethod} post - 发送 POST 请求
 * @property {tastien.sign.HTTPMethod} put - 发送 PUT 请求
 * @property {tastien.sign.HTTPMethod} delete - 发送 DELETE 请求
 */

/** @type {tastien.sign.HttpClient} */
var $httpClient;
 ...
 * @returns {Promise<tastien.sign.HTTPResponse>} 返回一个 Promise，解析为包含 error、response 和 data 的对象
 * @throws {Error} 如果请求失败，Promise 会被拒绝并返回错误信息
 */
async function request(method, params) {
    return new Promise((resolve, reject) => {
        /** @type {tastien.sign.HTTPMethod} */
 ...
 * 请求封装
 * @param {object} params
 * @returns {Promise<tastien.sign.HTTPResponse>}
 */
