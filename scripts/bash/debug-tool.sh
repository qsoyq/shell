...
pip install pydantic xmltodict PyYAML httpx bs4 typer rich tabulate socksio ipython pysocks ipython pyvim ruff you-get vcron pythonping dnspython --trusted-host pypi.org --trusted-host files.pythonhosted.org
